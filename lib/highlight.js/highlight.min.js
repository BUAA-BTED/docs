...
begin:'""'}],starts:a
},e.COMMENT("^\\s*%\\{\\s*$","^\\s*%\\}\\s*$"),e.COMMENT("%","$")]}}})());hljs.registerLanguage("less",(()=>{"use strict"
...
end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})})());hljs.registerLanguage("verilog",(()=>{"use strict";return e=>({name:"Verilog",
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("vhdl",(()=>{"use strict";return e=>({name:"VHDL",
...
begin:"'[A-Za-z](_?[A-Za-z0-9])*",contains:[e.BACKSLASH_ESCAPE]}]})})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("mipsasm",(()=>{"use strict";return e=>({
...
begin:"[0-9]+[bf]"}],relevance:0}],illegal:/\//})})());hljs.registerLanguage("json",(()=>{"use strict";return e=>({name:"JSON",
